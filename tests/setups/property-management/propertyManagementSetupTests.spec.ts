...
test.describe('Property Management Setup Tests', () => {
    test.setTimeout(60000); // Allow time for login + navigation

    test.beforeEach(async ({propertyManagementPage, loginPage}) => {
        ...
        await propertyManagementPage.clickOnPropertyManagementMenu();
        await propertyManagementPage.clickOnPropertyManagementSetupMenu();
    });
    test.describe('Setup Items', () => {
        test('Property type setup items should be available', async ({propertyManagementPage}) => {
            await propertyManagementPage.clickOnPropertyManagementMenu()
            await propertyManagementPage.clickOnPropertyManagementSetupMenu();
            await propertyManagementPage.page.pause();
        });
